  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="I’m Amar Omerika. I live in Mostar,Bosnia and Herzegovina, where I design the future."
        />
      </Head>
      <Container className="mt-16 sm:mt-32">
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="lg:order-first lg:row-span-2">
            ...
            I’m Amar Omerika. I live in Mostar, Bosnia and Herzegovina, where I design the future.
            </h1>
